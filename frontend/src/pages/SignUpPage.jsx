...
const SignUpPage = () => {
  ...
  <div className="flex justify-center items-center mt-20 mx-3">
    ...
    <form className="space-y-4" onSubmit={handleSignUp}>
      ...
      <input type="text" className="w-full px-3 mt-1 border border-gray-700 rounded-md bg-transparent text-white focus:outline focus:ring p-1.5" placeholder="enter your username" id="username" value={username} onChange={(e)=> setUsername(e.target.value)}/>
      </div> 
    ...
    <div className="text-center text-gray-400"> 
      already a member? &nbsp;
      <Link className="text-red-600 hover:underline transition duration-1000 ease-in" to={"/login"}>Sign In</Link>
    </div>
    </div>
  </div>
       </div>
